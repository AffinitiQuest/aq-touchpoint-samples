...
A FoalTS-based app that demonstrates use of the ```<aq-touchpoint/>``` component
...
[Modify Issuance Credential Attributes](src/app/controllers/webhook.controller.ts)
